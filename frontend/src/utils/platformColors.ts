...
export type Platform = 'anthropic' | 'openai' | 'openai_chat' | 'antigravity' | 'gemini'
...
const BADGE: Record<Platform, string> = {
  ...
  openai_chat: 'bg-teal-500/10 text-teal-600 border-teal-500/30 dark:text-teal-400',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  openai_chat: 'bg-teal-500/10 text-teal-600 dark:bg-teal-500/10 dark:text-teal-300',
...
const BORDER: Record<Platform, string> = {
  ...
  openai_chat: 'border-teal-500/20 dark:border-teal-500/20',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  openai_chat: 'bg-gradient-to-r from-teal-400 to-teal-500',
...
const TEXT: Record<Platform, string> = {
  ...
  openai_chat: 'text-teal-600 dark:text-teal-400',
...
const ICON: Record<Platform, string> = {
  ...
  openai_chat: 'text-teal-500 dark:text-teal-400',
...
const BUTTON: Record<Platform, string> = {
  ...
  openai_chat: 'bg-teal-600 text-white hover:bg-teal-700 active:bg-teal-800 dark:bg-teal-600/80 dark:hover:bg-teal-600',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  openai_chat: 'bg-teal-100 text-teal-700 dark:bg-teal-900/40 dark:text-teal-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  openai_chat: 'from-teal-500 to-teal-600',
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'openai_chat' || p === 'antigravity' || p === 'gemini'
}
